...
Revision ID: 3e6169708d96
Revises: 
Create Date: 2025-12-16 12:04:43.858903
...
def upgrade():
    ...
    with op.batch_alter_table('schedules', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_schedules_film_id'), ['film_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_schedules_show_time'), ['show_time'], unique=False)
...
def downgrade():
    ...
    with op.batch_alter_table('schedules', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_schedules_show_time'))
        batch_op.drop_index(batch_op.f('ix_schedules_film_id'))
